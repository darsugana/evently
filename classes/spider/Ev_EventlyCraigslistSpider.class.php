...
class Ev_EventlyCraigslistSpider extends Ev_EventlyAbstractSpider
{
	...
	public function isValid($data)
	{
		...
		$matches = array();
		preg_match('/syn:updateBase\>(.*)\<\/syn:updateBase/', $data, $matches);
	...
	{
		parent::spider(SourceGroup::CRAIGSLIST_SOURCE_GROUP_ID);
	}
