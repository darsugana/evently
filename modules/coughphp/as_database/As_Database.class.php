...
class As_Database {
	...
	/**
	 * Legacy method so we can get rid of matt database without replacing tons of
	 * code right now... DO NOT PORT THIS METHOD to public version of Cough/As_Database.
	 * 
	 * @deprecated
	 * @see selectDb()
	 * @author Anthony Bush
	...
	public function query($sql) {
		...
		$this->resultObject = $this->getResultObjectFromResource($result);
	...
	public function doInsert($tableName, $fields, $quotes = null, $dbName = '', $escape = true) {
		return $this->insert($tableName, $fields, $quotes, $dbName, $escape);
	}
	...
	public function doUpdate($tableName, $fields, $quotes=NULL, $where, $whereQuotes = NULL, $dbName = '', $escape = true) {
		return $this->update($tableName, $fields, $quotes, $where, $whereQuotes, $dbName, $escape);
	}
	...
	public function doInsertOrCancel($tableName, $fields, $quotes=NULL, $where) {
		return $this->insertOrCancel($tableName, $fields, $quotes, $where);
	}
	...
	public function doInsertOrUpdate($tableName, $fields, $quotes=NULL, $where) {
		return $this->insertOrUpdate($tableName, $fields, $quotes, $where);
	}
	 ...
	 * 
	 * @deprecated
	 * @see As_DatabaseResult
	 * @author Anthony Bush
	 **/
	public function getRow() {
		return $this->resultObject->getRow();
	}
	...
	public function getNumRows() {
		return $this->resultObject->getNumRows();
	}
}
